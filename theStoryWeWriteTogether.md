...
app/Modules/Card/StoryActsModule.php            # único módulo nuevo (código «relato»; «historia» es el del libro de aventuras) + citas verificadas
...
resources/views/admin/invitations/panels/modules/relato.blade.php     # un panel, secciones por acto
...
Solo citas con obra verificable (`StoryActsModule::QUOTES`); la pareja elige una en el editor:
