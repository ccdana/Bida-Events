        ...
        <div class="grid gap-4">
            ...
            <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div>
                    ...
                    <select x-model="meta.event_type_id" class="admin-input" required>
            ...
            <div>
                ...
                <select x-model="meta.user_id" class="admin-input">
            ...
            <div>
                ...
                <select x-model="meta.template" class="admin-input" required>
            ...
            <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div>
                    ...
                    <input type="datetime-local" x-model="meta.event_date" class="admin-input" required>
                </div>
                <div>
                    <label class="admin-label">Expira el</label>
                    <input type="date" x-model="meta.expires_at" class="admin-input" required>
                </div>
            </div>
            <div>
                <label class="admin-label">Estado</label>
                <select x-model="meta.status" class="admin-input">
