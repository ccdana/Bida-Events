...
@switch($name)
    ...
    @case('calendar')
        ...
        @break
    @case('heart')
        <svg class="{{ $class }} {{ $animClass }} icon-lucide-heart" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 1 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        @break
    @case('clock')
        <svg class="{{ $class }} {{ $animClass }} icon-lucide-clock" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
