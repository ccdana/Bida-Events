...
// ── Invitaciones en modo historia (~4 kB) — el mismo motor de las tarjetas, a pedido ─
if (document.querySelector('[data-inv-story]') && !document.querySelector('[data-story]')) {
...
// ── Libro de aventuras (~40 kB con page-flip) — hojas que se pasan y juego de memoria ─
if (document.querySelector('[data-notebook]')) {
    loaders.push(import('./aventura/index.js'));
}

// ── «Nuestra historia» — estanque de apertura y escenario que sigue la lectura ─
if (document.querySelector('[data-card="historia"]')) {
    loaders.push(import('./cards/historia/index.js'));
}
