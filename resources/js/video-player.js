/**
 * ────────────────────────────────────────────────────────────────────────────
 * Video Player  — Chunk dinámico
 *
 * Inicializa reproductores de video (video.js) y controles de
 * reproducción personalizados.  Se carga solo cuando la página
 * contiene elementos `[data-video-player]`.
 * ────────────────────────────────────────────────────────────────────────────
 */
...
// Auto-inicializar al cargar este chunk
initVideoPlayers();

// Re-inicializar en load por si hay elementos dinámicos
window.addEventListener('load', initVideoPlayers, { once: true });
