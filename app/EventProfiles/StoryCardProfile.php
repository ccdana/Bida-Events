 ...
 * el módulo «historia». Nada es obligatorio para publicar: cada acto tiene textos de respaldo.
 */
class StoryCardProfile extends EventProfile
{
    ...
    {
        return ['bienvenida', 'historia', 'juntos_desde', 'galeria', 'musica', 'dedicatoria', 'respuesta'];
    }
    ...
    public function required(): array
    {
        return [
            ...
            'historia' => ['anecdota' => 'Falta la anécdota: es el corazón del tercer acto'],
