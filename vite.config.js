...
export default defineConfig({
    plugins: [
        laravel({
            ...
            input: ['resources/css/app.css', 'resources/js/app.js', 'resources/css/invitation/story.css', 'resources/css/cards/amor.css', 'resources/css/cards/aventura.css', 'resources/css/cards/historia.css'],
            refresh: true,
        }),
        tailwindcss(),
    ],
